...
rosparam set /psn_unit4 "[ 1.5, 1.95, 7.8, 0.35, 3.14, 0.0]"
rosparam set /psn_unit3 "[-1.5, 1.95, 7.8, 0.35, 3.14, 0.0]"
...
echo 'Assign the parameters of 30 seats'
...
echo 'Set /seat_location and /seat_height'
